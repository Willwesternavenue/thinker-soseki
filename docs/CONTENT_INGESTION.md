...
## ⚠️ 最初に決めること: 対象は存命か、故人か(仕様が変わる)

**新しい人物でプロジェクトを始めるときは、まず対象が存命か故人かを確認する。**
これによって「カードが正しいことをどう保証するか(検証の拠り所)」が根本的に変わり、
確認シートの性格・persona の作り方・著作権の扱いまで影響する。

| 論点 | 存命の人物 | 故人 |
|---|---|---|
| **検証の拠り所** | **本人確認**。カードの中核命題・区別・禁止事項を本人(または代理)がレビューし承認する | **原典・学説との照合**。本人に聞けないため、著作・一次資料・研究上の合意と突き合わせる |
| **確認シート** | 本人が赤入れする「確認シート」 | 原典引用と突き合わせる「**校閲シート**」(該当箇所の出典を併記) |
| **persona の作り方** | 本人と対話しながら system_prompt・話し方・禁止語を詰められる | **著作・発言記録のみ**から構成する。推測部分は原典で裏取りする |
| **評価(A/B/C/D)** | 本人の判定を正とする | 原典適合・研究上の妥当性を正とする。判定者は編集側 |
| **著作権** | 本人・権利者と協議しやすい | **没年で保護期間を確認**(多くの法域で死後70年)。翻訳は訳者ごとに別途保護。私的検証は低リスクだが外部公開時は要留意 |
| **呼称正規化**(`lib/rag/session.ts`) | 敬称・通称ノイズの除去が主 | **表記ゆれ(原語綴り・複数の音写・区切り文字)の吸収**が主 |

存命前提の機能(本人確認フロー・本人評価)を故人にそのまま適用しない。故人の場合は
「本人に確認」を「原典に確認」へ読み替えて運用すること。
