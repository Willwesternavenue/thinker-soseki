...
| T5 | **完了 2026-07-27** `/creative` UI（入力検証・冪等送信・8段の進捗ポーリング・結果5タブ・失敗分類表示） | T2a（表示は T4c） | `frontend/src/app/creative/` |
| T5b | **完了 2026-07-27** `/admin/creative-generations`（ジョブ監視・heartbeat バナー・孤児検出・再実行・trace/guard 詳細） | T5 | `frontend/src/app/admin/creative-generations/` |
